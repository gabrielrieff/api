...
public class EventController {
    ...
    @PatchMapping("/{eventId}/registrations/cancel")
    public ResponseEntity<Void> cancelEventRegistration(@PathVariable UUID eventId, @LoggedUser User user){
        this.eventService.cancelEventRegistration(eventId, user.getId());
        return ResponseEntity.ok().build();
    }
}
